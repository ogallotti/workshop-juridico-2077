...
3. **"Site name"**
   → Digite o nome desejado (será: nome.netlify.app)

4. **"Your build command"**
   → Deixe VAZIO (apenas Enter)

5. **"Directory to deploy"**
   → Digite `.` (ponto)

6. **Autorização OAuth**
   → O navegador abrirá para autorizar conexão com GitHub
   → Peça ao usuário para autorizar
